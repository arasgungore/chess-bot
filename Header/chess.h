...
#define WHITE_BOT_DIFFICULTY 2		// the tree depth of decision tree of the bot, which is also correlated to the bot's difficulty (aka chess IQ)
#define BLACK_BOT_DIFFICULTY 2		// 1: easy, 2: medium, 3: hard
